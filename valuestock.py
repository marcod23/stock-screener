...
for x in range(10):
    ...
    q_fcf = fcf / 4
    for y in range(1, 5):
        present_value += q_fcf / (1 + q_discount_rate)**(4*x + y)  # raising the discount rate to 4x+y allows for quarterly discounting
...
print(dcf_mos30)  # 30% margin of safety
print(dcf_mos50)  # 50% margin of safety
